...
public class Model implements Serializable {
    ...
    public void setLibModel(String libModel) {
        this.libModel = libModel;
    }

    public int getTarifModel() {
        return tarifModel;
    }

    public void setTarifModel(int tarifModel) {
